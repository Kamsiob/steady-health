...
Decline reporting: described once, neutrally, paired with an action (the doctor page) and with everything that held. No colour change, no alarm, no repetition.
